...
When you sign up to {ecloud}, you create an **organization**.

This organization is the umbrella for all of your {ecloud} resources, users, and account settings. Every organization has a unique identifier. Bills are invoiced according to the billing contact and details that you set for your organization.
