...
![gif showing auto-indent for a console request](../../shared/images/auto-indent-devtools.gif)
...
![gif showing requests running in console](../../shared/images/devtool-run-request.gif)
