...
<DocImage size="m" url="media/auto-indent-devtools.gif" alt="gif showing auto-indent for a console request"/>
...
<DocImage size="m" url="media/devtool-run-request.gif" alt="gif showing requests running in console"/>
