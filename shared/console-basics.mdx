...
<DocImage size="m" url="./../../shared/media/auto-indent-devtools.gif" alt="gif showing auto-indent for a console request"/>
...
<DocImage size="m" url="./../../shared/media/devtool-run-request.gif" alt="gif showing requests running in console"/>
