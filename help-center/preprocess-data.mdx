...
- Transformation &mdash; Parse information from your documents to make sure they conform to a standardized format. For example, extract and raname fields, convert data types, remove or add fields, and more.
