...
Click <DocIcon type="expand" title="Toggle dialog with details" /> in the 
document table to show document details. You can review all document fields and
their corresponding values in the opening table. 
